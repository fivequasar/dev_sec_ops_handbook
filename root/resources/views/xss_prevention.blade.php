...
@include('layouts.navigation')
    ...
    <div class="main">
        ...
        <div class="description" style="flex: none;border-radius: 0px;">
            ...
            <a href="{{route('validate_xss')}}"><button class="buttons" id="sandboxOne" style="display: inline-block;">Initiate Input Validation Sandbox ></button></a>
            ...
            <p>This helps better defend against a SQL injection. For more information regarding creating patterns for input validation, go to https://regexr.com/.</p>
                    ...
                    <a href="{{route('validate_xss')}}"><button class="buttons">Initiate Input Validation Sandbox ></button></a>
        ...
        <div class="description" style="border-radius: 0px; padding-top: 0px;border-radius: 0px 0px 10px 10px;">
            ...
            <div class="sub_description" style="background-image: url('images/prepared.png');margin-top: 0px; background-size: 285.11px 142.56px;">
                ...
                <a href="{{route('encoding')}}"><button class="buttons" id="sandboxTwo" style="display: inline-block;">Initiate HTML Encoding Sandbox ></button></a>
                ...
                <div id="roadTwo">
                    ...
                    <p>So why does the browser still displays the "<" and the single quotation marks as they are and not their encoded counterparts? Lets break it down:</p>
                            ...
                            <a href="{{route('encoding')}}"><button class="buttons">Initiate HTML Encoding Sandbox ></button></a>
        ...
        <div class="description">
            ...
            <a href="{{route('xss_secure_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Initiate Secure XSS Sandbox Demo ></button></a>

...
<div class="main">
    ...
    <div class="row">
        ...
        <p>Take a look at line <b>14</b> you will notice that we have a preg_match function in place. Depending on the context of your function within the website, the regular expression that you have set should be what you will expect coming from the user. In this case, the regular expression are as of the following:</p>
        ...
        <a href="{{route('sql_secure_front_end')}}"><button class="buttons">View Front-End Code</button></a>

...
<p style="margin: 0px;background-color: #111;color: white;padding: 20px 20px 0px 20px; border-radius: 10px 10px 0px 0px;">There are two ways to counter SQL Injections, <b>Input Validation</b>, and <b>Prepared Statement</b></p>
    ...
    <div class="description" style="flex: none;border-radius: 0px;">
        ...
        <a href="{{route('validate_sqli')}}"><button class="buttons" id="sandboxOne" style="display: inline-block;">Initiate Input Validation Sandbox ></button></a>
        ...
        <a href="{{route('validate_sqli')}}"><button class="buttons">Initiate Input Validation Sandbox ></button></a>
...
<div class="sub_description" style="background-image: url('images/code.png');margin-top: 0px; background-size: 285.11px 142.56px;">
    ...
    <h3 style="margin-top: 0px;">Prepared Statement</h3>
        ...
        <a href="{{route('prepared')}}"><button class="buttons" id="sandboxTwo" style="display: inline-block;">Initiate Prepared Statement Sandbox ></button></a>
        ...
        <a href="{{route('prepared')}}"><button class="buttons">Initiate Prepared Statement Sandbox ></button></a>
...
<a href="{{route('sql_secure_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Initiate Secure SQL Sandbox Demo ></button></a>

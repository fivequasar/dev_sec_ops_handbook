...
$code = file_get_contents('code_templates/xss_dom/xss_dom_bn.php');
    ...
    <div class="main">
        ...
        <div class="row">
            ...
            <div class="editor_column">
                <h3 style="margin-top: 0px;">Why is this considered a DOM-based XSS attack?</h3>
                ...
                <a href="{{route('dom_front_end')}}"><button class="buttons">View DOM XSS Front End</button></a>

...
<ol>
    ...
    <li>The browser interprets the injected script as JavaScript and executes it, causing an alert with the message 'XSS.'</li>
        ...
        <div class="description">
            ...
            <a href="{{route('dom_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Initiate DOM-based XSS Sandbox Demo ></button></a>

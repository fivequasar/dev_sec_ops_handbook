...
@include('layouts.navigation')
    ...
    <div class="row">
        ...
        <p><b>Conclusion: </b>Through this way of validation, you can approve what type of data that is accepted or else let the user know that the input is invalid. </p>

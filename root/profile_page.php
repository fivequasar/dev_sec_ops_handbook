...
<body>
    ...
    <div>
        ...
        <input id="urlInput" type="text" value="" style="width:640px; height:25px; font-size: 16px;">
    ...
    <div class="profile-container">
        <h2>Your Profile</h2>
        <img class="profile-picture" src="/root/images/profile_icon.jpg" alt="Profile Picture">

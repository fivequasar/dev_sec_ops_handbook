...
<br>
    ...
    <div class="description">
        ...
        <a href="{{route('blind_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Initiate Blind SQLi Sandbox Demo ></button></a>

    ...
    <div class="main">
        ...
        <div class="row">
            ...
            <div class="editor_column">
                ...
                <b>Using <b style="font-family:'Courier New', Courier, monospace">htmlspecialchars()</b> for encoding</b>

                <p>Let's analyse the syntax that is required for <b style="font-family:'Courier New', Courier, monospace">htmlspecialchars()</b> to function</p>
                ...
                <p>The <b style="font-family:'Courier New', Courier, monospace">ENT_QUOTES</b> in the second parameter basically means that the function will also encode single and double quotes. There are other type of flags but this is the most common one to prevent XSS attacks</p>

                <p>Copy the script below and paste it in the <b style="font-family:'Courier New', Courier, monospace">$username</b> variable on line <b>2</b> and Run Code:</p>

                <p><span class="code_space">&lt;script&gt;alert('XSS');&lt;/script&gt;</span><button class="buttons" onclick="copyTextOne()">Copy</button></p>


                <p>The output will return the script string but because the special characters are encoded into their HTML entities on the server side, they are are now treated as plain text instead of executable scripts on the client side. As an example, it will convert the symbols like "<b style="font-family:'Courier New', Courier, monospace"><</b>" and "<b style="font-family:'Courier New', Courier, monospace">></b>" to <b style="font-family:'Courier New', Courier, monospace" >&amp;lt;</b> and <b style="font-family:'Courier New', Courier, monospace">&amp;gt;</b>.</p>


                <p>If you want to see what the output would be without the encoding:</p>
                <ol>
                    <li><p>Replace the <b style="font-family:'Courier New', Courier, monospace">$encodedUsername</b> variable on line <b>4</b> with the <b style="font-family:'Courier New', Courier, monospace">$username</b> variable and run the code again with the script that was used earlier</p></li>
                ...
                <p><b>Conclusion: </b><b style="font-family:'Courier New', Courier, monospace">htmlspecialchars()</b> translates special characters to HTML entities, preventing them from being interpreted as code and improving security by reducing the danger of cross-site scripting (XSS) attacks.</p>

    ...
    <div class="main">
        ...
        <table>
            <tr>
                ...
                <td>
                    <a href="{{route('blind_front_end')}}"><button class="buttons">Swap to Boolean-Based Demo</button></a>
                </td>
            </tr>
        </table>
            ...
            <a href="{{route('blind_time_back_end')}}"><button class="buttons">View Time-Based attack back-end</button></a>

...
@include('layouts.navigation')
    ...
    <div class="row">
        ...
        <tr>
            ...
            <td>
            <a href="{{route('in_band_front_end')}}"><button class="buttons">Swap to Error-Based Demo</button></a>
            </td>
        </tr>
        </table>
        ...
        <ol>
            ...
            <p>To determine how many columns are there within this query used for this login component, copy it within the username field and send it over each row one by one:</p>
        ...
        <a href="{{route('in_band_back_union_end')}}"><button class="buttons">View Union-based Back End</button></a>

...
<div class="main">
    ...
    <div class="editor_column">
       ...
       <ol>
        ...
        <p><span class="code_space" style="margin-right: 10px;">' UNION SELECT name FROM products -- </span> <button class="buttons" onclick="copyTextOne()">Copy</button></p>
       ...
       <ol>
        ...
        <a href="{{route('in_band_front_union_end')}}"><button class="buttons">View Union-based Front-end</button></a>

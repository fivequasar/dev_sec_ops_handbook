...
<div class="main">
    ...
    <div class="row">
        ...
        <b>Using the SUBSTRING operator to perform Boolean Based SQLi</b>
        ...
        <a href="{{route('blind_front_end')}}"><button class="buttons">View Boolean-Based attack front-end</button></a>

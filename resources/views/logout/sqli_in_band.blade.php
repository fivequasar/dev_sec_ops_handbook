    ...
    <div class="main">
        ...
        <div class="description" style="border-radius: 0px 0px 10px 10px; padding-top: 0px;">
            ...
            <div class="sub_description" style="background-image: url('images/union.png'); margin-top: 0px;">
                ...
                <p>An attackers use the SQL operator <span class="code_space" style="padding: 2px 10px 2px 10px;">UNION</span>. This operator when used in a SQL query combines the results of two or more <span class="code_space" style="padding: 2px 10px 2px 10px;">SELECT</span> statements. </p>
                ...
                <div id="roadTwo">
                    ...
                    <ol class="list">
                        ...
                        <br>
                        <li>Within the attacker's payload, the attacker first used a quotation at the start so as to close the quotation of the original query, allowing the <span class="code_space" style="padding: 2px 10px 2px 10px;">UNION</span> command to work.</li>
                        <br>
        ...
        <div class="description">
            ...
            <a href="{{route('in_band_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Login To Initiate In Band SQLi Sandbox Demo ></button></a>

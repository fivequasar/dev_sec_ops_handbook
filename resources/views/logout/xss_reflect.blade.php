...
<a href="{{route('reflect_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Login To Initiate Reflected XSS Demo ></button></a>

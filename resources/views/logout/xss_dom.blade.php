...
<div class="main">
        ...
        <div class="description" style="border-radius: 10px 10px 0px 0px; padding-bottom: 0px;">
            ...
            <div class="sub_description" style="background-image: url('images/code.png'); background-size: 285.11px 142.56px;">
                ...
                <h2 style="margin-top: 0px;">DOM XSS</h2>
        ...
        <div class="description" style="border-radius: 0px; padding: 0px 10px 0px 10px;">
            ...
            <div class="sub_description" style="background-image: url('images/example.png'); background-size: 192.53px 224.66px;">
...
<ol>
    ...
    <li>The browser interprets the injected script as JavaScript and executes it, causing an alert with the message 'XSS.'</li>
        ...
        <div id="road">
            ...
            <p style="margin: 0px;">Let's analyse this further:</p>
            ...
            <button class="buttons" id="readLess" onclick="toggleOff()" style="display: none;">Read Less</button>
                ...
                <div class="sub_description" style="background-image: url('images/con.png'); background-size: 214.17px 197.67px;" >
        ...
        <div class="description">
            ...
            <a href="{{route('dom_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Login To Initiate DOM-based XSS Sandbox Demo ></button></a>

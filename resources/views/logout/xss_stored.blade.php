...
<div class="main">
        ...
        <a href="{{route('stored_front_end')}}" style="width: 100%;"><button class="buttons" style="width: 100%; text-align:left;padding: 20px;font-size: 20px;">Login To Initiate Stored XSS Demo ></button></a>

...
<div class="description">
    ...
    <div class="sub_description" style="background-image: url('images/in_band.png');" > 
        ...
        <p><b>Description: </b>Being the most frequent type of SQL injections, attackers insert malicious data on a website and immediately retrieve the results of it, all within the same communication interface (E.g, Web Browser). There are two common types of In-band SQLi, Error-based SQLi and Union-based SQLi.</p>  
...
<br>
    ...
    <div class="description">
        ...
        <h2 style="margin-top: 0px;">Error-based</h2>

        <p><b>Description: </b>An attacker purposely enters data that may cause the database server to produce error messages back to the attacker. These error messages may provide information regarding the database's structure. </p>
        ...
        <p><b>Example: </b>An attacker performs an error based SQLi on a search function.</p>
            ...
            <ol class="list">
                ...
                <li>The attacker purposely adds a quotation at the end of the input to cause an error, the database reflects an error back on the same web browser where the attack was launched:</li>
                    <br>
                <div class="code_space"><p style="margin: 0px;">You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ''1''' at line 1;</p></div>
                    <br>
            ...
            <p><b>Consequences: </b>When these errors are not caught, an attacker can use the information to get:</p>
            ...
            <p>Based on the information here, attackers may be able to craft specific attacks based on the type and version of the database being exploited or perform a further exploit using the information attained through the error-based attack the database.</p>
    ...
    <h2 style="margin-top: 0px;">Union-based</h2>
